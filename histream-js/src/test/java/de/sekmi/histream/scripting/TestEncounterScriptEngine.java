...
public class TestEncounterScriptEngine {
	...
	public void multipleCalls() throws Exception{
		...
		VisitPatientImpl v1 = new VisitPatientImpl("v1", p1, DateTimeAccuracy.parsePartialIso8601("2001-02-03", null));
		Observation[] facts = new Observation[]{
				factory.createObservation(v1, "C1", DateTimeAccuracy.parsePartialIso8601("2011")),
				factory.createObservation(v1, "C2", DateTimeAccuracy.parsePartialIso8601("2011-02-01")),
				factory.createObservation(v1, "C3", DateTimeAccuracy.parsePartialIso8601("2011-02-01"))				
		};
