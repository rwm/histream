...
public class TestDateTimeAccuracy {
	...
	@Test
	public void verifyLocalIso() throws ParseException {
		ZoneId z = ZoneId.of("Asia/Shanghai");
		DateTimeAccuracy d = DateTimeAccuracy.parsePartialIso8601("2019-03", z);
		Assert.assertEquals("2019-03", d.toPartialLocalIso(z));

		Assert.assertEquals("2019-03-04", DateTimeAccuracy.parsePartialIso8601("2019-03-04", z).toPartialLocalIso(z));
		Assert.assertEquals("2019-03-04T03", DateTimeAccuracy.parsePartialIso8601("2019-03-04T03", z).toPartialLocalIso(z));
	}

	@Test
	public void verifyLocalDateTime() throws ParseException {
		ZoneId z = ZoneId.of("Asia/Shanghai");
		DateTimeAccuracy d = DateTimeAccuracy.parsePartialIso8601("2019-03", z);
		Assert.assertEquals("2019-03-01T00:00", d.toLocal(z).toString());
	}
	@Test
