...
//	protected String encounterId;
	...
	@XmlTransient
	protected VisitPatientImpl visit;
	...
	public static ObservationImpl createObservation(VisitPatientImpl visit, String conceptId, DateTimeAccuracy startTime) {
		ObservationImpl impl = new ObservationImpl();
		impl.setVisit(visit);
...
//	public void setPatientId(String patientId){this.patientId = patientId;}
	...
	public void setVisit(VisitPatientImpl visit) {
		this.visit = visit;
	}
	...
	public void setVisit(Visit visit) {
		if( !(visit instanceof VisitPatientImpl) ) {
			throw new IllegalArgumentException("Visit expected of type VisitPatientImpl");
		}
		setVisit((VisitPatientImpl)visit);
	}
...
//		clone.patientId = this.patientId;
	 ...
	 */
	public void removeContext(DateTimeAccuracy startTime, ExternalSourceType source){
//		if( this.patient != null && patientId != null && this.patient.getId().equals(patientId) ){
////			this.patientId = null;
//		}
//		if( this.visit!= null && encounterId != null && this.visit.getId().equals(encounterId) ){
...
//		}
	 ...
	 * @param source source context
	 */
	public void fillFromContext(DateTimeAccuracy startTime, ExternalSourceType source) {
		if( this.source == null ){
			setSource(source);
		}else if( source != null ){
